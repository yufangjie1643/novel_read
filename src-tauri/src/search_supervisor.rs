...
pub struct SearchSnapshot {
    ...
    pub duration_ms: u64,
    /// Wall-clock seconds since UNIX_EPOCH when this snapshot was
    /// captured. Stored as u64 instead of `Instant` because `Instant`
    /// doesn't implement `serde::Serialize` and the IPC boundary
    /// needs an absolute timestamp anyway.
